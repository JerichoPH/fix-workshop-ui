        ...
        Route::prefix("organization")
            ->group(function () {
                ...
                Route::prefix("station")
                    ->name("OrganizationStation:")
                    ->group(function () {
                        Route::get("", "OrganizationStationController@Index")->name("Index");  // 站场列表
                        Route::get("create", "OrganizationStationController@Create")->name("Create");  // 新建站场页面
                        Route::get("{uuid}", "OrganizationStationController@Show")->name("Show");  // 站场详情
                        Route::get("{uuid}/edit", "OrganizationStationController@Edit")->name("Edit");  // 站场详情
                        Route::post("", "OrganizationStationController@Store")->name("Store");  // 站场角色
                        Route::put("{uuid}", "OrganizationStationController@Update")->name("Update"); // 站场角色
                        Route::delete("{uuid}", "OrganizationStationController@Destroy")->name("Destroy");  // 删除站场
                    });

                // 道口
                Route::prefix("railroadGradeCross")
                    ->name("OrganizationRailroadGradeCross:")
                    ->group(function () {
                        Route::get("", "OrganizationRailroadGradeCrossController@Index")->name("Index");  // 道口列表
                        Route::get("create", "OrganizationRailroadGradeCrossController@Create")->name("Create");  // 新建道口页面
                        Route::get("{uuid}", "OrganizationRailroadGradeCrossController@Show")->name("Show");  // 道口详情
                        Route::get("{uuid}/edit", "OrganizationRailroadGradeCrossController@Edit")->name("Edit");  // 道口详情
                        Route::post("", "OrganizationRailroadGradeCrossController@Store")->name("Store");  // 道口角色
                        Route::put("{uuid}", "OrganizationRailroadGradeCrossController@Update")->name("Update"); // 道口角色
                        Route::delete("{uuid}", "OrganizationRailroadGradeCrossController@Destroy")->name("Destroy");  // 删除道口
                    });
                ...
                Route::prefix("section")
                    ...
                    ->group(function () {
                        Route::get("", "OrganizationSectionController@Index")->name("Index");  // 区间列表
                        Route::get("create", "OrganizationSectionController@Create")->name("Create");  // 新建区间页面
                        Route::get("{uuid}", "OrganizationSectionController@Show")->name("Show");  // 区间详情
                        Route::get("{uuid}/edit", "OrganizationSectionController@Edit")->name("Edit");  // 区间详情
                        Route::post("", "OrganizationSectionController@Store")->name("Store");  // 区间角色
                        Route::put("{uuid}", "OrganizationSectionController@Update")->name("Update"); // 区间角色
                        Route::delete("{uuid}", "OrganizationSectionController@Destroy")->name("Destroy");  // 删除区间
                    });
                ...
                Route::prefix("center")
                    ...
                    ->group(function () {
                        Route::get("", "OrganizationCenterController@Index")->name("Index");  // 中心列表
                        Route::get("create", "OrganizationCenterController@Create")->name("Create");  // 新建中心页面
                        Route::get("{uuid}", "OrganizationCenterController@Show")->name("Show");  // 中心详情
                        Route::get("{uuid}/edit", "OrganizationCenterController@Edit")->name("Edit");  // 中心详情
                        Route::post("", "OrganizationCenterController@Store")->name("Store");  // 中心角色
                        Route::put("{uuid}", "OrganizationCenterController@Update")->name("Update"); // 中心角色
                        Route::delete("{uuid}", "OrganizationCenterController@Destroy")->name("Destroy");  // 删除中心
                    });
            });
    });
