...
class CreateAccountsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('accounts', function (Blueprint $table) {
            ...
            $table->string('organization_railway_uuid')->nullable(true)->comment('归属路局UUID');
            $table->index('organization_railway_uuid');
            $table->string('organization_paragraph_uuid')->nullable(true)->comment('归属站段UUID');
            $table->index('organization_paragraph_uuid');
            $table->string('organization_workshop_uuid')->nullable(true)->comment('归属车间UUID');
            $table->index('organization_workshop_uuid');
            $table->string('organization_work_area_uuid')->nullable(true)->comment('归属工区UUID');
