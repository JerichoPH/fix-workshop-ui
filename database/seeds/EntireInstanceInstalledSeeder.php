...
class EntireInstanceInstalledSeeder extends Seeder
{
    ...
    public function run()
    {
        for ($i = 0; $i < 5000; $i++) {
            ...
            $identityCode = \App\Facades\CodeFacade::makeEntireInstanceIdentityCode($entireModelUniqueCode);
            ...
            $fixWorkflowSerialNumber = CodeFacade::makeSerialNumber('FIX_WORKFLOW') . strval(++$i);
            $fixWorkflow = [
