...
@section('script')
    <script>
        ...
        let organizationWorkAreaType = null;
        ...
        function fnInit() {
            $.ajax({
                url: `{{ route("web.OrganizationWorkAreaType:Show", ["uuid" => $uuid,]) }}`,
                type: 'get',
                data: {},
                async: true,
                success: res => {
        ...
        function fnUpdate() {
            ...
            $.ajax({
                url: `{{ route('web.OrganizationWorkAreaType:Update', ["uuid" => $uuid , ]) }}`,
                type: 'put',
                data,
                success: function (res) {
                    console.log(`{{ route('web.OrganizationWorkAreaType:Update', ["uuid" => $uuid, ]) }} success:`, res);
                    layer.close(loading);
