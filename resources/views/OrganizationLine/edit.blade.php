                ...
                <div class="box box-solid">
                    ...
                    <form class="form-horizontal" id="frmUpdate">
                        ...
                        <div class="box-footer">
                            <a href="{{ route('web.OrganizationLine:Index') }}" class="btn btn-default pull-left btn-flat btn-sm"><i class="fa fa-arrow-left btn-flat">&nbsp;</i>返回</a>
        ...
        function fnInit() {
            $.ajax({
                ...
                success: res => {
                    ...
                    let {unique_code: uniqueCode, name, be_enable: beEnable,} = organizationLine;
