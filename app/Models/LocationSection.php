...
class LocationSection extends Model
{
    ...
    {
        return $this->belongsToMany(LocationLine::class, "pivot_location_line_and_location_sections", "location_section_id", "location_line_id");
    }
    ...
    {
        return $this->belongsTo(PositionIndoorRoom::class,"location_section_uuid","uuid");
    }
    ...
    {
        return $this->belongsTo(EntireInstanceLog::class,"location_section_uuid","uuid");
    }
}
