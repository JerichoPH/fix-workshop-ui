...
class Base extends Model
{
     ...
     * @return Builder
     */
    final public function ReadOneByUUID(string $uuid): Builder
    {
        return self::with($this->__default_withs)->where("uuid", $uuid);
    }
     ...
     * @return Builder
     */
    final public function ReadOneBySerialNumber(string $serial_number): Builder
    {
        return self::with($this->__default_withs)->where("serial_number", $serial_number);
    }
