...
class PartController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $warehouseProductPartIds = PivotFromWarehouseProductToWarehouseProductPart::where('warehouse_product_id', request('warehouseProductId'))->pluck('warehouse_product_part_id')->toArray();
