                ...
                <div class="col-md-5">
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-9">
                                    <input name="unique_code" id="txtUniqueCode" type="text" class="form-control" placeholder="唯一，必填 6位：H00001" required value="" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <a href="{{ route('web.LocationSection:Index') }}" class="btn btn-default btn-sm pull-left"><i class="fa fa-arrow-left">&nbsp;</i>返回</a>
...
@section('script')
    <script>
        ...
        function fnStore() {
            ...
            $.ajax({
                url: '{{ route('web.LocationSection:Store') }}',
                type: 'post',
                data,
                success: function (res) {
                    console.log(`{{ route('web.LocationSection:Store') }} success:`, res);
                    layer.close(loading);
                ...
                error: function (err) {
                    console.log(`{{ route('web.LocationSection:Store') }} fail:`, err);
                    layer.close(loading);
                    layer.msg(err["responseJSON"]["msg"], {icon: 2,}, function () {
                        if (err.status === 401) location.href = '{{ route('web.Authorization:GetLogin') }}';
                    });
